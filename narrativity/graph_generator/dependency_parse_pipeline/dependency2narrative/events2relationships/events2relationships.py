...
from narrativity.graph_generator.dependency_parse_pipeline.dependency2narrative.events2relationships.events2temporal_relationships.events2temporal_relationships import Events2TemporalRelationships
...
class Events2Relationships:
    def __init__(self):
        ...
        self._events2temporal_relationships = Events2TemporalRelationships()
    ...
    def load(self):
        ...
        self._events2temporal_relationships.load()
    ...
    def extract(self, narrative_1, narrative_2, phrase_connector, narrative_graph):
        extractor_classes = [
            ...
            self._events2temporal_relationships,
        ]
