...
class AnecdotalRelationship(AbstractRelationship):
    _type = "anecdotal_relationship"
    ...
    def from_dict(val, narrative_graph):
        ...
        anecdotal_relationship.set_id(val['id'])
        anecdotal_relationship.set_narrative_graph(narrative_graph)
        anecdotal_relationship.set_is_to_relationship(val['is_to_relationship'])
        anecdotal_relationship.set_relationship(val['relationship'])
        anecdotal_relationship.set_narrative_1_id(val['narrative_1_id'])
        anecdotal_relationship.set_narrative_2_id(val['narrative_2_id'])
        return anecdotal_relationship
    ...
    def create():
        anecdotal_relationship = AnecdotalRelationship()
        anecdotal_relationship.set_id(str(uuid.uuid4()))
        return anecdotal_relationship
