...
class ContradictoryRelationship(AbstractRelationship):
    ...
    def display_name(self):
        ...
        contradictory = "{} contradicts {}".format(narrative_2, narrative_1)
    ...
    def from_dict(val, narrative_graph):
        contradictory_relationship = ContradictoryRelationship()
        contradictory_relationship.set_narrative_graph(narrative_graph)
        contradictory_relationship.set_narrative_1_id(val['narrative_1_id'])
        contradictory_relationship.set_narrative_2_id(val['narrative_2_id'])
        contradictory_relationship.set_anecdotal_in_relationship_ids(val['anecdotal_in_relationship_ids'])
        contradictory_relationship.set_mark(val['mark'])
